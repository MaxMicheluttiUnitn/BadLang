...
enum class ReductionKind{
    ...
    EQUALITY__NAME_PLUSEQ_OP,
    EQUALITY__NAME_MINUSEQ_OP,
    EQUALITY__NAME_TIMESEQ_OP,
    EQUALITY__NAME_DIVIDEEQ_OP,
    EQUALITY__NAME_MODULUSEQ_OP,
    CONDITIONAL__IF_OPEN_OP_CLOSE_BLOCK,
    CONDITIONAL__IF_OPEN_OP_CLOSE_BLOCK_ELSEIFS,
    ELSEIFS__ELIF_OPEN_OP_CLOSE_BLOCK_ELSEIFS,
    ELSEIFS__ELIF_OPEN_OP_CLOSE_BLOCK,
    ELSEIFS__ELSE_BLOCK,
};
